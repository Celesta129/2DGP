...
def draw_curve_5_points(p1, p2, p3, p4, p5):
    ...
    # draw p4-p5
    draw_curve_3_points(p4,p5,p1)
    pass


prepare_turtle_canvas()

draw_curve_5_points(points[0], points[1], points[2], points[3],points[4])
#draw_curve_5_points(points[], points[1], points[2], points[3],points[4])
